document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (minLength && value.length < parseInt(minLength, 10)) {
        showError(field, field.dataset.errorMinlength || 'This field is too short.');
        return false;
      }

      const maxLength = field.getAttribute('maxlength');
      if (maxLength && value.length > parseInt(maxLength, 10)) {
        showError(field, field.dataset.errorMaxlength || 'This field is too long.');
        return false;
      }
  ...
  const ANIMATION_SELECTOR = '.animate-on-scroll, .fade-in, .slide-up, .slide-in';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אובליגו משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7aeaa539-2c94-4068-a631-e19632335db3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7aeaa539-2c94-4068-a631-e19632335db3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7aeaa539-2c94-4068-a631-e19632335db3';
